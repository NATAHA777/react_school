        ...
        <div className="heder">
          ...
          <div className="notice_and_sign_in">
            <div className="notice">
              <button>
                  <img src="public/external/notice.svg" alt="уведомления"/>
              </button>
            </div>
      ...
      <div className="content">
        ...
        <div className="onlice_school">
          ...
          <div className="button_learn_more">
            Узнать больше
            <img src="public/external/arrow_learn_more.svg" />
          </div>
        </div>
        <div className="teachers">
          ...
          <div className="teacher_list">
            <div>
              <img src="public/external/director.png" />
          ...
          <div className="buttons_arrow">
            <div className="button_left">
              <button>
                  <img src="public/external/button_list_none_active.svg" alt="назад"/>
              </button>
            </div>
            <div className="button_right">
              <button>
                  <img src="public/external/button_list_active.svg" alt="далее"/>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="contacts">
          ...
          <div className="contact_list">
            <div>
              <img src="public/external/phone.svg" />
              <span>+7 954 143 83 83</span>
            </div>
            <div>
              <img src="public/external/mail.svg" />
              <span>sosh5taishet@mail.ru</span>
            </div>
          </div>
          <div className="social_network">
              <img src="public/external/vk.svg"/>
              <img src="public/external/telegram.svg"/> 
              <img src="public/external/viber.svg"/>
            </div>
        </div>
      </div>
      </div>
